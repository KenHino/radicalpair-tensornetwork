...
parallel = True
nthreads = 1  # numbr of theread per process (only valid if parallel==True)
nprocs   = 8
...
np.save(f"symmetry_reduction_N{2*N}", singlet_probability)


# If you want to plot, comment out following commands
#import matplotlib.pyplot as plt
# plt.plot(time*1e+09, np.exp(-k*time)*singlet_probability)
#plt.plot(time*1e+09, singlet_probability)
#plt.grid()
#plt.ylim(0.0, 1.0)
#plt.xlim(0.0, 200)
#plt.savefig("sym.png")
